                ...
                <div className="container">
                    ...
                    <ul className='nav nav-pills'>
                        <li className='nav-item'>
                            <a className="nav-link text-light bg-green ov-btn-grow-ellipse" href="/login">
                                <i className="bi bi-box-arrow-in-right iniciarSesion"> Iniciar Sesion</i>
                            </a>
                        </li>
            ...
            <Navbar className="navbar-expand-md bg-success navColor">
                <div className="container justify-content-center">
                    <ul className='navbar-nav'>
                        ...
                        <li className="nav-item mx-4">
                            <a className="nav-link text-white letrasDoradads" href="">Servicios de BDB</a>
                        </li>
                                ...
                                {listaBanco.map((t) => {
                                    return (
                                        <li key={t._id}>
                                            ...
                                            ><img className='imaBancos' src={t.img} /> - {t.nombre}</NavDropdown.Item>
                                        </li>
                        ...
                        <li className="nav-item mx-4">
                            <a className="nav-link text-white" href="#">Funcionalidad de BDB</a>
                        </li>
                        ...
                        >
                            ...
                            >
                                ...
                                <NavDropdown.Item href="https://mail.google.com/mail/u/0/#inbox?compose=CllgCJZWPrjbGNlxcdSvhprcmmJfWMRzGFtTrqRKJlpzPPWGLMnzZmkdNrFGFtMDGXdrsgkrkFg">correo electronico</NavDropdown.Item>
                                <NavDropdown.Item href="#action1">Formulario de pregunta</NavDropdown.Item>
                            </NavDropdown>
                        </li>
