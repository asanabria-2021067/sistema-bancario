...
export const CuentaTransferencia = () => {
  ...
  return (
    <>
      ...
      <div className="container containerCuentas mt-4">
      
        <div>
          {cuenta.length > 0 ? (
            cuenta
              .filter((c) => c.tipoCuenta.tipo === "Monetaria") // Filtrar solo las cuentas monetarias
              .map((c, index) => (
                <a key={c._id} href={`/transferencia/${c._id}`} onClick={(event) => {
                  event.preventDefault();
                  navigate(`/transferencia/${c._id}`);
                }}>
                <div
                  className="floating mt-4"
                ...
                >
                  ...
                  <div className="card_body">
                    ...
                    <div className="card_info">
                      ...
                      <div className="valid_date2 text">
